...
public class Pratice311 {
	public static void main(String[] args) {
        ...
        Collections.sort(classroom,(sc1,sc2) -> 
        							(sc1.getHeight() == sc2.getHeight() ? 0 :
...
class SchoolChild implements Comparable<SchoolChild>{
	...
	@Override
	public int compareTo(SchoolChild no) {
		return Integer.compare(this.no, no.getNo());
	}
}
